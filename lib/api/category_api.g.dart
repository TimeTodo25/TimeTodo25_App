...
class _CategoryApi implements CategoryApi {
  ...
  @override
  Future<CategoryListResponse> categoryList(int idx) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'user_idx': idx};
  ...
  @override
  Future<bool> categoryDelete(int idx) async {
    final _extra = <String, dynamic>{};
