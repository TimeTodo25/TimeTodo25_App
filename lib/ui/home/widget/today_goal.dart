                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      // 오늘의 목표 텍스트
                      Text(todayGoal, style: Theme.of(context).textTheme.bodyLarge)
                    ],
                  ),
                ),
              ],
...
// 오늘의 목표 아이콘
Widget todayGoalIcon(String iconPath) {
  return SizedBox(
    width: 70,
    height: 70,
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Row(
          children: [
            const Icon(CupertinoIcons.alarm_fill,
