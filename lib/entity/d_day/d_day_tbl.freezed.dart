    ...
    return _then(_value.copyWith(
      ...
      targetDt: null == targetDt
          ...
          : targetDt // ignore: cast_nullable_to_non_nullable
              as DateTime,
      targetDelStatus: null == targetDelStatus
...
class _$DdayImpl implements _Dday {
  ...
  @override
  String toString() {
    return 'Dday(idx: $idx, syncIdx: $syncIdx, content: $content, targetDt: $targetDt, targetDelStatus: $targetDelStatus, createDt: $createDt, updateDt: $updateDt, status: $status, syncStatus: $syncStatus, syncDt: $syncDt)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, idx, syncIdx, content, targetDt,
      targetDelStatus, createDt, updateDt, status, syncStatus, syncDt);
