...
// 서버 동기화 시간
  ...
  @override
  String toString() {
    return 'TimerModel(idx: $idx, historyEndDt: $historyEndDt, historyStartDt: $historyStartDt, totalTm: $totalTm, todoIdx: $todoIdx, syncIdx: $syncIdx, syncCategoryIdx: $syncCategoryIdx, syncDt: $syncDt, syncStatus: $syncStatus)';
  }
